...
#define DUT_AXI(name) axi4MemPort_0_##name

template<typename DUT>
void axi_aw_bind_dut(DUT *dut_ptr, axi_aw_channel &aw)
{
...
#define axi_aw_set_dut_ptr_unused(dut_ptr, aw)                   \
  do {                                                    \
    dut_ptr->DUT_AXI(aw_ready) = aw.ready;                \
  } while (0);

template <typename DUT>
void axi_w_bind_dut(DUT *dut_ptr, axi_w_channel &w)
{
...
#define axi_w_set_dut_ptr_unused(dut_ptr, w)                     \
  do {                                                    \
    dut_ptr->DUT_AXI(w_ready) = w.ready;                  \
  } while (0);

template <typename DUT>
void axi_b_bind_dut(DUT *dut_ptr, axi_b_channel &b)
{
...
#define axi_b_set_dut_ptr_unused(dut_ptr, b)                     \
  do {                                                    \
...
template <typename DUT>
void axi_ar_bind_dut(DUT *dut_ptr, axi_ar_channel &ar)
{
...
#define axi_ar_set_dut_ptr_unused(dut_ptr, ar)                   \
  do {                                                    \
    dut_ptr->DUT_AXI(ar_ready) = ar.ready;                \
  } while (0);

template <typename DUT>
void axi_r_bind_dut(DUT* dut_ptr, axi_r_channel &r)
{
...
#define axi_r_set_dut_ptr_unused(dut_ptr, r)                     \
  do {                                                    \
...
template<typename DUT>
void axi_bind_dut(DUT *dut_ptr, axi_channel &axi)
{
    axi_aw_bind_dut(dut_ptr, axi.aw);
    axi_w_bind_dut(dut_ptr, axi.w);
    axi_b_bind_dut(dut_ptr, axi.b);
    axi_ar_bind_dut(dut_ptr, axi.ar);
    axi_r_bind_dut(dut_ptr, axi.r);
}

#define axi_set_dut_ptr_unused(dut_ptr, axi)                     \
  do {                                                    \
